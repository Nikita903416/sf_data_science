...
По результатам анализа исходного кода функции game_core_v2 уставнолено, что при увеличении значение переменной predict больше чем на 1 - число попыток на отгадывая числа падает. Данное заключение было использовано для реалиизации решения
